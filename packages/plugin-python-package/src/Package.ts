...
import {BuildableBehaviour, DeployableBehaviour, InstallableBehaviour, PreInstallableBehaviour, TestableBehaviour, CleanableBehaviour} from "@genjs/genjs-behaviours";
