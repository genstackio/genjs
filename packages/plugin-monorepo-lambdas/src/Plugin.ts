...
export default class Plugin implements IPlugin {
    ...
    onMonorepoLambdasHydrate(p: IPackage, eventType: string, ctx: any): void {
    ...
    onProjectHydrate(p: IPackage, eventType: string, ctx: any): void {
        if ('monorepo-lambdas' === p.getPackageType()) return;
    ...
    register(generator: IGenerator): void {
        ...
        generator.registerPackager('monorepo-lambdas', cfg => new Package(cfg));
    }
}
