...
export default class Package extends JavascriptPackage {
    ...
    protected buildMakefile(vars: any) {
        const t = super.buildMakefile(vars)
            ...
            .addPredefinedTarget('start', 'js-dev', {options: {port: this.getParameter('startPort')}, sourceLocalEnvLocal: vars.sourceLocalEnvLocal})
            .addPredefinedTarget('serve', 'js-start', {options: {port: this.getParameter('servePort')}, sourceLocalEnvLocal: vars.sourceLocalEnvLocal})
