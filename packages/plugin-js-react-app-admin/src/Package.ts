import {AbstractPackage, BasePackageConfig, GitIgnoreTemplate, LicenseTemplate, MakefileTemplate, ReadmeTemplate, TerraformToVarsTemplate, BuildableBehaviour, DeployableBehaviour, InstallableBehaviour, StartableBehaviour, TestableBehaviour, GenerateEnvLocalableBehaviour} from '@genjs/genjs';
